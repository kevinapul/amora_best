...
$classes = ($active ?? false)
    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[var(--alkon-green)] text-sm font-semibold leading-5 text-gray-900 focus:outline-none transition duration-150 ease-in-out'
