...
@php
$attendanceToday = \App\Models\Attendance::where('user_id', Auth::id())
    ->latest()
    ->first();
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-md sm:rounded-lg p-6 mb-4 flex justify-between items-center">
            <div>
                ...
                <p class="text-gray-600">Kamu berhasil login. Silakan pilih menu di bawah untuk mulai bekerja.</p>
            </div>
        ...
        <div
            ...
            <a href="{{ route('event-training.index') }}" class="block bg-white p-6 shadow-md sm:rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="{{ route('event-staff.events') }}" class="block bg-white p-6 shadow-md sm:rounded-lg hover:bg-gray-100 transition">
            ...
            <a href="{{ route('laporan') }}" class="block bg-white p-6 shadow-md sm:rounded-lg hover:bg-gray-100 transition">
